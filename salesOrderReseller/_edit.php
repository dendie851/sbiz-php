			...
			<legend><b>JENIS PEMBELIAN<b></legend>			
				<table width="100%">
					<tr>
						...
						<td><b><?php echo strtoupper($dataHeader['reseller_name']) ?></b></td>
					<tr>
				</table>
		</fieldset>
		<br />	
		<fieldset>
			<legend><b>DATA PEMBELI<b></legend>			
				<table width="100%">
					...
					<tr>
						<td width="" rowspan="2"  valign="top">ALAMAT PENGIRIMAN</td>
						<td colspan="4" rowspan="2" >
							<textarea name="address" style="width:650px; height:50px" disabled><?php echo isset($_POST['address']) ? $_POST['address'] : $dataHeader['address_shipping'] ?></textarea>
		...
		<fieldset>
			...
			<table width="100%">
				...
				<tr>
					...
					<td  rowspan="2">
						<textarea disabled name="descriptionPayment" style="height:50px; width:180px"><?php echo isset($_POST['descriptionPayment']) ? $_POST['descriptionPayment'] : $dataHeader['description_payment'] ?></textarea>

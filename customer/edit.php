		...
		<form action="editSave.php" method="post">
			...
			<table width="100%">
				...
				<tr>
					...
					<td>
						<input name="countryCode" type="text" size="1" value="<?php echo isset($_POST['countryCode']) ? $_POST['counteryCode'] : $data['country_code'] ?>" />
...
<script type="text/javascript">
	$(document).ready(function() {
		$(function() {
				...
				<?php $tmp = isset($_REQUEST['dateInput']) ? strlen(trim($_REQUEST['dateInput'])) == 0 ?  '' : explode('/',$_REQUEST['dateInput']) : explode('/',$data['date_input_frm']) ?>
				<?php if($tmp[0] != '00'): ?>	

<?php ob_start(); ?>
	<?php include 'editRead.php' ?>
		<h1>GUDANG EKSTERNAL</h1>
		<hr />
		<form action="editSave.php" method="post">
			<input name="id" type="hidden" value="<?php echo $data['id'] ?>" />			
			<input name="code_hidden" type="hidden" value="<?php echo $data['code'] ?>" />			
			<table width="100%">
			<tr>
				...
				<tr>
					...
					<td valign="top">
						<textarea name="address" style="height:150px; width:410px"><?php echo isset($_POST['address']) ? $_POST['address'] : $data['address'] ?></textarea>
					</td>
				</tr>
			</table>
			<hr />

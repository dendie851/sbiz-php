		...
		<div id="tbl">
			<table width="100%">
				<thead>
					...
					<th style="font-size:12px; font-weight:bold" align="center" width="150">KOMISI</th>
				</thead>
				<?php $j=1 ?>
				<tbody>
				<?php $jumlah = 0 ?>
				...
				<?php while($rowdataSub = mysqli_fetch_array($data)): ?>
					<tr>
						...
						<td style="font-size:12px"  align="center"><b><?php echo number_format($rowdataSub['amount_fee_affiliate'],0,0,'.') ?></b></td>
					</tr>	
					<?php $jumlah = $jumlah + $rowdataSub['total_nilai'] ?>
					<?php $totalKomisi = $totalKomisi + $rowdataSub['amount_fee_affiliate'] ?>						
					<?php $j++ ?>	
				<?php endwhile; ?>	

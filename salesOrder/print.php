		...
		<div id="tbl">
			<table width="100%" border="0" style=" border:1px solid black; padding:0; font-size:14pt;" cellspacing="0" cellpadding="0">
				...
				<tfoot>	
					...
					<tr>
						<td  style="padding:5px;  font-size:12pt;  border:1px solid black;" align="left" colspan="4"><b>BIAYA KIRIM SEBELUM DISKON</b> 
						</td style="padding:5px;  font-size:12pt;  border:1px solid black;">
						<td style="padding:5px;  font-size:12pt;  border:1px solid black;" align="center">
							Rp. <?php echo number_format($dataHeader['shipping_cost_before_discount'],0,'','.') ?>  
						</td>
					</tr>												

					<tr>
						<td style="padding:5px;  font-size:12pt;  border:1px solid black;"align="left" colspan="4"><b>DISKON BIAYA KIRIM</b> 
						</td>
						<td style="padding:5px;  font-size:12pt;  border:1px solid black;" align="center">
							Rp.  <?php echo number_format($dataHeader['shipping_cost_discount'],0,'','.') ?>						
						</td>
					</tr>												

			...
			<div id="tbl">
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tbody>
						...
						<?php while($val = mysql_fetch_array($data)): ?>
							<tr>
								...
								<td style="padding:5px; font-size:12pt; border:1px solid black" align="center"align="center"><?php echo number_format($val['price_total_basic'],0,'','.') ?></td>													
								<td style="padding:5px; font-size:12pt; border:1px solid black" align="center"><?php echo number_format($val['price_total'],0,'','.') ?></td>							
					...
					<tr>
						...
						<th style="padding:5px; font-size:12pt; border:1px solid black"><?php echo number_format($totalHargaDasarJual,0,'','.') ?></th>

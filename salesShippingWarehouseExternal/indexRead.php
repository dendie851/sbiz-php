<?php 
	...
	$warehouseExternalId = isset($_REQUEST['warehouseExternalId']) ? general::secureInput($_REQUEST['warehouseExternalId']) : 'x';

	$where = '';
	$where .= $warehouseExternalId != "x" ? " and warehouse_external_id = '$warehouseExternalId' " : '';

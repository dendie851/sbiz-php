<?php
	...
	header("Content-Disposition: attachment; filename=LAPORAN KOMISIxls");
?>
			...
			<div id="tbl">
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tbody>
						...
						<?php while($val = mysql_fetch_array($data)): ?>
							<tr>
								...
								<td style="padding:5px; font-size:12pt; border:1px solid black" align="center"><?php echo $val['total_fee_reseller'] ?></td>							
					...
					<tfoot>
						...
						<th style="padding:5px; font-size:12pt; border:1px solid black"><?php echo $totalTransaksi ?> Transaksi</th>
						<th style="padding:5px; font-size:12pt; border:1px solid black"><?php echo $totalNilaiJual ?></th>
						<th style="padding:5px; font-size:12pt; border:1px solid black"><?php echo $totalKomisi ?></th>

			...
			<table width="100%">
				<thead>			
					<tr>
						...
						<th align="center" width="25%">BIAYA ADMIN PERSEN</th>
						<th align="center" width="20%">MARKETPLACE</th>
						<th></th>
					</tr>	
				</thead>
				<tbody>
					...
					<?php while($val = mysql_fetch_array($data)): ?>
						<tr>
							...
							<td align="center"><?php echo $val['fee_admin_percent'] ?> %</td>
							<td align="center">
								<?php if($val['is_marketplace'] == '1'): ?>

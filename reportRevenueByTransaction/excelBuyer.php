<?php
	...
	header("Content-Disposition: attachment; filename=LAPORAN-DATA-PEMBELI.xls");
?>
				...
				<table width="100%" style="font-size:12pt; border:1px solid black" cellpadding="0" cellspacing="0">
					<thead>			
						<tr>
							...
							<th style="padding:5px; font-size:11pt; border:1px solid black" align="center" width="%">SALES</th>
					...
					<tbody>
						...
						<?php while($val = mysql_fetch_array($data)): ?>
							<tr>
								<td align="center" style="font-size:11pt; border:1px solid black"><?php echo $i ?></td>
								<td align="center" style="padding:8px; font-size:12pt; border:1px solid black">
								...
								<td style="padding:5px; font-size:11pt; border:1px solid black" align="center">&nbsp;<?php echo strlen($val['phone']) < 50 ? trim(str_replace(array('+',' ','-'), '',$val['phone'])) : '' ?></td>								
					...
					<tbody>
					<tr>
						<th style="padding:5px; font-size:11pt; border:1px solid black" colspan="5" align="left" style="text-align:center">GRAND TOTAL</th>
						<th style="padding:5px; font-size:11pt; border:1px solid black">&nbsp;<?php echo $total ?>&nbsp;</th>
					</tr>	
				</table>			
			</div>
		<?php endif; ?>

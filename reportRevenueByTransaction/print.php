			...
			<div id="tbl">
				<table width="100%" style="font-size:12pt; border:1px solid black" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalHargaDasar,0,'','.') ?></th>
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalHargaJual,0,'','.') ?></th>
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalDiskon,0,'','.') ?></th>
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($grandTotalDiskoNominal,0,'','.') ?></th>
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalHargaJualAfterDiskon,0,'','.') ?></th>						
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalLaba,0,'','.') ?></th>
						<th style="padding:5px; font-size:11pt; border:1px solid black"><?php echo number_format($totalBiayaKirim,0,'','.') ?></th>
					</tr>
					<?php if($costAdds > 0): ?>
					<tr>

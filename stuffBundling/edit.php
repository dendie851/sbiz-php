...
<form action="editSave.php" method="post" enctype="multipart/form-data">
	...
	<table width="100%">
		...
		<tr>			
			...
			<td>
				<input name="priceMin" type="text" value="<?php echo isset($_POST['priceMin']) ? $_POST['priceMin'] : $data['price_min'] ?>" />
		...
		<tr>			
			...
			<td>
				<input name="feeSales" type="text" value="<?php echo isset($_POST['feeSales']) ? $_POST['feeSales'] : $data['fee_sales'] ?>" />

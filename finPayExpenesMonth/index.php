			...
			<table width="100%" border="1">
				<thead>			
					<tr>
						...
						<th align="center" width="25%">NAMA KOMPONEN</th>
						<th align="center" width="22%">KETERANGAN</th>
				...
				<tbody>
					...
					<?php while($val = mysql_fetch_array($data)): ?>
						<tr>
							...
							<td align="center"><?php echo number_format($val['nominal'],0,0,'.') ?></td>
							<td align="center">

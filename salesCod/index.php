				...
				<tr>
					<td width="30%">			
						<select name="actionType" id="actionType" style="width:200px;">
							...
							<option value="1">Validasi Pembayaran COD</option>
						</select>
				...
				<table width="100%">
					<thead>			
						<tr>
							...
							<th align="center" width="27%">NAMA PEMBELI</th>
							<th align="center" width="13%">PEMBAYARAN</th>

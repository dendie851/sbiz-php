			...
			<tr>
				...
				<td>
					<select name="positionId" style="width:155px">
						<?php while($val = mysqli_fetch_array($dataPosition)): ?>
							<option value="<?php echo $val['id'] ?>" <?php echo $val['id'] == (isset($_REQUEST['positionId']) ? $_REQUEST['positionId'] : '') ? 'selected' : '' ?>><?php echo $val['name'] ?></option>
						<?php endwhile; ?>
					</select>
				</td>
			</tr>									
			<tr>
				...
				<td>
					<select name="aktif" style="width:155px">
						<option value="1" <?php echo isset($_REQUEST['aktif']) ? $_REQUEST['aktif'] == '1' ? 'selected' : '' : '' ?>>YA</option>
						<option value="0" <?php echo isset($_REQUEST['aktif']) ? $_REQUEST['aktif'] == '0' ? 'selected' : '' : '' ?>>TIDAK</option>
					</select>
				</td>
			</tr>
			<!--	

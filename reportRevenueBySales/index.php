				...
				<table width="100%">
					<thead>			
						<tr>
							...
							<th style="font-size:12px" align="center" width="%">NAMA SALES</th>						
					...
					<tbody>
						...
						<?php while($val = mysql_fetch_array($data)): ?>
							<tr>
								...
								<td align="center">
									<span class="button"> 
										<a data-title="DETAIL" data-width="650" data-height="400" href="detail.php?salesId=<?php echo $val['sales_id'] ?>&statusOrder=<?php echo $statusOrder ?>&statusPayment=<?php echo $statusPayment ?>&dateFrom=<?php echo urlencode($_REQUEST['dateFrom']) ?>&dateTo=<?php echo urlencode($_REQUEST['dateTo']) ?>" />[ DETAIL ]</a>
									<span>		
								</td>	
